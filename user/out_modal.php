        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Deixando sala...</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
					<h3><center>Você não pode deixar esta sala.</center></h3>
					<span style="font-size: 11px;"><center><i>OBS: Você está matriculado nesta turma. Se houver divergência, contate um administrador.</i></center></span>
                </div> 
				</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger" id="confirm_delete2"><span class="glyphicon glyphicon-check"></span> Deletar</button>
